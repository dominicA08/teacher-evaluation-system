...
const NAV_ITEMS = [
  ...
  { label: 'History',   icon: BookOpen,        to: '/student/history'   },
];
...
export default function StudentSidebar() {
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="p-5 border-b border-border-steel">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-xs font-semibold text-gold-primary uppercase tracking-wider capitalize truncate">
              {profile ? parseName(profile.email) : 'Student'}
            </p>
      ...
      {/* ── Navigation ───────────────────────────────────────────────── */}
      <nav className="flex-1 py-4 px-3 space-y-1" aria-label="Student navigation">
      ...
      <div className="lg:hidden">
        <div className="flex items-center justify-between px-4 py-3 bg-[#111E35]/90 border-b border-border-steel sticky top-0 z-40 backdrop-blur-md">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-text-primary">Student Portal</span>
          </div>
          <button
