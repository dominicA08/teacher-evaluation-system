  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (error) {
        ...
        // Successful login, navigate to student dashboard
        // Note: Protected route will direct to ID verification if student is pending
  ...
  return (
    <div className="min-h-screen circuit-bg flex flex-col justify-center py-12 px-4 relative">
      <div className="w-full max-w-md mx-auto">
        ...
        <AuthCard title="Student Portal" subtitle="Sign in to evaluate your teachers">
